...
* write: ssh cs15lsp23__@ieng6.ucsd.edu ->replace the underline corresponding to your personal account (because of some issues with the server, I had to personally use my school account rather than my cs15lsp23__ account. I was able to log in with my account and password on the CSE basement computer but when trying to run it in my terminal to remotely connect it failed. Regardless, the steps should be the same)
