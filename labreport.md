...
<br>
<img width="819" alt="Screen Shot 2023-04-06 at 5 31 41 PM" src="https://user-images.githubusercontent.com/130107069/230517119-61e3cf37-d004-4413-a5e1-5e696a1e8386.png">
...
* write: ssh cs15lsp23__@ieng6.ucsd.edu ->replace the underline corresponding to your personal account 
* (because of some issues with the server, I had to personally use my school account rather than my cs15lsp23__ account. I was able to log in with my account and password on the CSE basement computer but when trying to run it in my terminal to remotely connect it failed. Regardless, the steps should be the same)
